    ...
    <>
      ...
      <div className="topnav" id="myTopnav">
        ...
        <div className="one">
          <li>
            <Link
              ...
              className={activeNav === "#" ? "" : ""}
            >
              <img className="navimg" src="home1.png" alt="" />
              Shiksha<span className="text-blue">Sankalp</span>
            </Link>
          </li>
          <li className="all-li">
            <Link
          ...
          <li className="all-li">
            <Link
              to="/instructor"
              onClick={() => setActiveNav("#instructor")}
              className={activeNav === "#instructor" ? "active" : ""}
            >
        ...
        <div>
          ...
          >
            <button className="loginbtn btn">Login / Register</button>
          </li>
        </div>
